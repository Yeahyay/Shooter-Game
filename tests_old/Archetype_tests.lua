...
cute.notion("Archetype creation with no archetypes fails", function()
	cute.check(pcall(Feint.ECS.Archetype.new, nil)).is(false)
end)
...
cute.notion("Archetype creation with one component works", function()
	...
	cute.check(TestArchetype1.Name).is("ARCHETYPE_TEST_COMPONENT_1")
...
cute.notion("Archetype creation with two components works", function()
	...
	cute.check(TestArchetype2.Name).is("ARCHETYPE_TEST_COMPONENT_1ARCHETYPE_TEST_COMPONENT_2")
...
cute.notion("Archetype creation with three components works", function()
	...
	cute.check(TestArchetype3.Name).is("ARCHETYPE_TEST_COMPONENT_1ARCHETYPE_TEST_COMPONENT_2ARCHETYPE_TEST_COMPONENT_3")
