...
local minion = function (name, tbl, k)
...
local notion = function (title, testMethod)
  table.insert(tests, {
    title=title,
    run=testMethod
  })
...
local f_notion = function (title, testMethod)
...
local x_notion = function (title, testMethod)
  -- do nothing
end
...
cute.notion = notion
cute.f_notion = f_notion
cute.x_notion = x_notion
cute.check = check
cute.minion = minion
cute.report = report
