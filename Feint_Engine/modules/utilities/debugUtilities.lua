local debugUtilities = {logLevel = 0}

debugUtilities.PRINT_ENV_Level = 3
function debugUtilities.PRINT_ENV(env, verbose, restrict)
	if true then
		...
		if debugUtilities.logLevel >= debugUtilities.PRINT_ENV_Level then
...
debugUtilities.DEBUG_PRINT_TABLE_Level = 1
function debugUtilities.DEBUG_PRINT_TABLE(table, format)
	if debugUtilities.logLevel >= debugUtilities.DEBUG_PRINT_TABLE_Level then
		printf("---\n")
